...
def alumniLogin():
    if request.method == 'POST':
        ...
        query3 = ("SELECT EnrollmentNumber from Opportunities_for_hiring O Where O.Company={} AND W.Position='{}' AND W.Field='{}'").format(company, position_in_opportunities, field)
